...
describe("Fuction to test Item component", () => {
	const input = {
	...
	it('should render with this brand and model that corresponds', () => {
		render(
			<Router>
				<Item id ={input.id} model={input.model} imgUrl={input.imgUrl} price={input.price} brand={input.brand} />
			</Router>
		);
